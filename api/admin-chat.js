...
Вычлени из текста пользователя время (на сколько часов или дней скидка). Переведи это время строго в ЧАСЫ. Если время не указано, по умолчанию ставь 24.
❗️ ВАЖНО: В поле "reply" ты ОБЯЗАН динамически написать цену и точный срок, на который ставится таймер!
{"action": "set_promo", "product_name": "Имя или ID курса", "promo_price": 999, "duration_hours": 24, "reply": "Я готов включить акцию (999 ₽). Таймер будет установлен ровно на 24 часа. Подтверждаете?"}
