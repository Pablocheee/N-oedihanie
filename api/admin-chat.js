...
❗️ ВАЖНО: Если пользователь просит создать курс, но НЕ указал его название (написал просто "создай курс"), категорически запрещено использовать 'create_product'. Выбери action "help" и ответь: "Пожалуйста, укажите название для нового курса. Например: «Создай курс Пробуждение»".
Если название в запросе ЕСТЬ, сгенерируй базовые поля. Для курса: new_id - это одно слово на английском мелкими буквами.
{"action": "create_product", "product_name": "Название из запроса пользователя", "new_id": "engid (или дата)", "category": "Категория", "short_desc": "", "image_url": "", "full_desc": "", "price_rub": 0, "price_usdt": 0, "reply": "Каркас курса готов. Добавляем в базу?"}
